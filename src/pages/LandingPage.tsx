...
export default function LandingPage() {
  ...
  return (
    <>
      ...
      {/* Minimal global styles — only what Tailwind can't express */}
      <style>{`
        :root {
        ...
        .accent-text {
          background: linear-gradient(135deg, #E8C77A 0%, #D4A843 100%);
        ...
        .step-line {
          position: absolute; left: 19px; top: 40px; bottom: -32px;
          width: 1px;
          background: linear-gradient(to bottom, #2E2E33, transparent);
        }
      `}</style>
